...
var
  ...
  procedure InsertSettings(StringListSettings: TStringList; TextSection: string; TextName: string);
  var
    IndexLine: Integer;
...
begin
  ...
  InsertSettings(StringListPaths, 'Core.System', 'Paths');
  InsertSettings(StringListPackages, 'Editor.EditorEngine', 'EditPackages');
